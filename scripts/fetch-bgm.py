...
GONGU = [
    ...
    (
        ...
        "오정석, 한국저작권위원회 CC BY", 74.0, 47.2,
        "오디세우스가 10년을 어떻게 보냈나 — 제목이 그대로 이 편이다. "
        "칼립소가 붙잡아 둔 7년이 10년의 70%고, 곡 이름이 「여기 머물라」다. "
        "분위기가 아니라 편의 야마와 맞물린다. 공유마당 요약도 '느린 피아노 "
        "연주곡으로 서정적인 느낌을 자아내는 낭만적인 곡'이라 배가 거의 안 "
        "움직이는 이 편에 맞는다. 150초 중 74초부터가 중역 95%로 지금까지 "
