...
PRESETS = {
    # 훅이 4초로 늘었다(글자를 한 자씩 쓰느라). 구간 경계가 전부 그만큼
    # 뒤로 밀린다. 여기 숫자는 각 컴포지션의 HOOK/LEGS와 같아야 한다.
    "imjin": {
        "out": "public/bgm.wav",
        "dur": 40.0,
        "hook": 4.0,
        "sections": [
            (4.0, 13.0, 41.2, 82, 116),    # 1592 북상 — 가속
            (13.0, 21.0, 61.7, 116, 104),  # 1593 반격 — 5도 위
            (21.0, 25.0, 36.7, None, None),  # 강화 협상 — 정지
            (25.0, 33.0, 38.9, 104, 138),  # 1597 — 가장 빠름
            (33.0, 39.0, 41.2, 100, 76),   # 종결
        ],
        "accents": [(6.2, 0.8), (8.6, 0.9), (11.0, 1.0),
                    (14.8, 0.9), (17.6, 1.0),
                    (26.2, 0.9), (28.4, 1.0), (30.2, 1.0)],
    },
    "kw": {
        ...
        "hook": 4.0,
        "sections": [
            (4.0, 12.0, 41.2, 84, 124),    # 남침 → 낙동강, 조여든다
            (12.0, 19.0, 61.7, 124, 108),  # 인천상륙 → 서울 수복, 5도 위
            (19.0, 25.0, 65.4, 108, 98),   # 북진 → 압록강
            (25.0, 32.0, 36.7, 98, 142),   # 중공군 → 1·4후퇴, 가장 빠르고 낮게
            (32.0, 37.0, 41.2, 142, 92),   # 재수복 → 38선 고착
            (37.0, 42.0, 38.9, None, None),  # 고지전 2년 — 정지
        ],
        "accents": [(5.0, 1.0), (11.0, 1.0),      # 남침·낙동강
                    (13.0, 1.0), (17.0, 0.9),     # 인천상륙·서울수복
                    (23.6, 1.0),                  # 압록강
                    (26.0, 1.0), (30.8, 1.0),     # 중공군·1·4후퇴
                    (41.2, 1.0)],                 # 정전
    },
    "ty": {
        ...
        "sections": [
            (4.0, 13.5, 38.9, 68, 80),     # 사라
            (13.5, 25.0, 41.2, 76, 88),    # 루사
            (25.0, 34.5, 36.7, 84, 96),    # 매미
            (34.5, 45.0, 32.7, 92, 108),   # 힌남노 — 가장 낮고 빠르게
            (45.0, 52.5, 41.2, None, None),  # 마무리 — 북이 빠지고 여운
        ],
        # 각 태풍의 상륙 시점(구간의 72%)에 타격
        "accents": [(10.8, 1.0), (21.8, 1.0), (31.8, 1.0), (42.1, 1.0), (45.5, 0.9)],
    },
}
