...
PRESETS = {
    "imjin": {
        ...
        "hook": 2.4,
        "sections": [
            (2.4, 11.4, 41.2, 82, 116),    # 1592 북상 — 가속
            (11.4, 19.4, 61.7, 116, 104),  # 1593 반격 — 5도 위
            (19.4, 23.4, 36.7, None, None),  # 강화 협상 — 정지
            (23.4, 31.4, 38.9, 104, 138),  # 1597 — 가장 빠름
            (31.4, 37.4, 41.2, 100, 76),   # 종결
        ],
        "accents": [(4.6, 0.8), (7.0, 0.9), (9.4, 1.0),
                    (13.2, 0.9), (16.0, 1.0),
                    (24.6, 0.9), (26.8, 1.0), (28.6, 1.0)],
    },
    "kw": {
        ...
        "hook": 2.4,
        "sections": [
            (2.4, 10.4, 41.2, 84, 124),    # 남침 → 낙동강, 조여든다
            (10.4, 17.4, 61.7, 124, 108),  # 인천상륙 → 서울 수복, 5도 위
            (17.4, 23.4, 65.4, 108, 98),   # 북진 → 압록강
            (23.4, 30.4, 36.7, 98, 142),   # 중공군 → 1·4후퇴, 가장 빠르고 낮게
            (30.4, 35.4, 41.2, 142, 92),   # 재수복 → 38선 고착
            (35.4, 40.4, 38.9, None, None),  # 고지전 2년 — 정지
        ],
        "accents": [(3.4, 1.0), (9.4, 1.0),      # 남침·낙동강
                    (11.4, 1.0), (15.4, 0.9),    # 인천상륙·서울수복
                    (22.0, 1.0),                 # 압록강
                    (24.4, 1.0), (29.2, 1.0),    # 중공군·1·4후퇴
                    (39.6, 1.0)],                # 정전
    },
    "ty": {
