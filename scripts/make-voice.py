...
SCRIPTS = {
    ...
    "center": [
        "대한민국 사람의 한가운데는 어디일까요?",
        "땅만 놓고 재면 충북 옥천군이에요. 국토의 무게중심입니다.",
        "5,108만 명을 얹으면 중심이 북서쪽으로 46.8킬로미터 "
        "미끄러져요. 충북 청주입니다.",
        "서울에서 109킬로미터, 부산에서 221킬로미터인 자리예요.",
        "인구 51퍼센트가 수도권인데, 왜 이만큼밖에 안 올라왔을까요?",
        "경기도 1,377만 명을 빼면 34.7킬로미터 남쪽, 옥천군입니다.",
        "부산 323만 명을 빼면 반대로 14.6킬로미터 북쪽이에요. "
        "남쪽도 당기고 있는 겁니다.",
        "두 한가운데는 46.8킬로미터 떨어져 있어요. "
        "국토 남북 612킬로미터의 7.6퍼센트입니다. "
        "여러분 동네는 그 점에서 몇 킬로미터인가요?",
    ],
}
