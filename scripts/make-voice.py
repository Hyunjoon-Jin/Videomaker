...
SCRIPTS = {
    ...
    "metro": [
        "직선으로 1.1킬로미터. 지하철로는 몇 정거장일까요?",
        "관악구 낙성대역과 동작구 남성역입니다. 직선으로 1.1킬로미터예요.",
        "그런데 지하철로 가면 사당, 서초, 고속터미널을 돌아서 "
        "8정거장, 10.8킬로미터입니다.",
        "직선의 9.9배. 서울에서 가장 많이 돌아가는 두 역이에요.",
        "2등은 미아사거리와 월곡. 1.6킬로미터를 11정거장 돌아갑니다.",
        "3등은 발산과 양천향교. 김포공항을 거쳐서 5정거장이에요.",
        "서울 안 역 317곳을 다 견줘 봤어요. "
        "여러분 동네에도 이런 데 있나요?",
    ],
}
