...
import { ShortsMetro, METRO_DURATION } from "./ShortsMetro";
import { ShortsRush, RUSH_DURATION } from "./ShortsRush";
import { ShortsCenter, CENTER_DURATION } from "./ShortsCenter";
...
export const RemotionRoot: React.FC = () => (
  <>
    ...
    <Composition
      id="ShortsMetro"
      component={ShortsMetro}
      durationInFrames={METRO_DURATION}
      fps={FPS}
      width={SHORT_W}
      height={SHORT_H}
    />
    <Composition
      id="ShortsRush"
      component={ShortsRush}
      durationInFrames={RUSH_DURATION}
      fps={FPS}
      width={SHORT_W}
      height={SHORT_H}
    />
    <Composition
      id="ShortsCenter"
      component={ShortsCenter}
      durationInFrames={CENTER_DURATION}
      fps={FPS}
      width={SHORT_W}
      height={SHORT_H}
    />
