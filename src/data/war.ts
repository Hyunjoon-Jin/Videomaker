...
export const WAR_EVENTS: WarEvent[] = [
  ...
  { month: 1.4, date: "1592년 5월", title: "옥포 해전", detail: "이순신 첫 승리", win: true, sea: { x: 600, y: 810 }, impact: 0.5 },
  { month: 2, date: "1592년 6월", title: "평양 함락", detail: "선조는 의주까지 피난", impact: 0.85 },
  { month: 3, date: "1592년 7월", title: "한산도 대첩", detail: "학익진 — 제해권 장악", win: true, sea: { x: 570, y: 822 }, impact: 1 },
  ...
  { month: 65, date: "1597년 9월", title: "명량 대첩", detail: "13척으로 133척을 막다", win: true, sea: { x: 450, y: 878 }, impact: 1 },
  { month: 76, date: "1598년 8월", title: "도요토미 사망", detail: "일본군 철수 결정" },
  { month: 79, date: "1598년 11월", title: "노량 해전", detail: "이순신 전사 — 7년 전쟁 종결", win: true, sea: { x: 530, y: 840 }, impact: 1 },
];
