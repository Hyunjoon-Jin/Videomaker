...
export const WAR_EVENTS: WarEvent[] = [
  ...
  { month: 3, date: "1592년 7월", title: "한산도 대첩", detail: "학익진으로 제해권을 잡다", win: true, sea: "한산도", impact: 1 },
  { month: 3.6, date: "1592년 7월", title: "이치 전투", detail: "전라도 방어선을 지켜내다", win: true, impact: 0.6 },
  { month: 6, date: "1592년 10월", title: "1차 진주성", detail: "김시민이 전라 진입을 막다", win: true, impact: 0.8 },
  { month: 4.5, date: "1592년 8월", title: "연안성 방어", detail: "이정암이 황해도 요충을 지키다", win: true, impact: 0.6 },
  { month: 8.5, date: "1592년 12월", title: "북관대첩", detail: "정문부가 함경도를 되찾다", win: true, impact: 0.9 },
  ...
  { month: 63, date: "1597년 7월", title: "칠천량 패전", detail: "조선 수군이 궤멸하고 정유재란이 시작되다", impact: 0.9 },
  ...
  { month: 79, date: "1598년 11월", title: "노량 해전", detail: "이순신이 전사하고 7년 전쟁이 끝나다", win: true, sea: "노량", impact: 1 },
];
