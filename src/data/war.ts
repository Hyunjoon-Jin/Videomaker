...
export interface WarEvent {
   ...
   * 카메라가 볼 곳 [경도, 위도]와 배율.
   *
   * 샷 목록을 따로 손으로 적었더니 화면과 자막이 어긋났다. 한산도
   * 얘기를 하는데 카메라는 평안도를 보고 있는 식이다. 사건이 곧
   * 구도여야 어긋날 수가 없으므로 여기에 붙인다.
   * focus가 없으면 반도 전체를 본다.
   */
  focus?: [number, number];
  zoom?: number;
}
...
export const WAR_EVENTS: WarEvent[] = [
  { month: 0, date: "1592년 4월", title: "부산 상륙", detail: "일본군 약 15만 8천, 조선 침공", impact: 0.6, focus: [129.08, 35.18], zoom: 3.1 },
  { month: 1, date: "1592년 5월", title: "한양 함락", detail: "상륙 20일 만에 수도 함락", impact: 0.9, focus: [126.98, 37.50], zoom: 2.7 },
  { month: 1.4, date: "1592년 5월", title: "옥포 해전", detail: "이순신 첫 승리", win: true, sea: "옥포", impact: 0.5, focus: [128.70, 34.87], zoom: 3.2 },
  { month: 2, date: "1592년 6월", title: "평양 함락", detail: "선조는 의주까지 피난", impact: 0.85, focus: [125.75, 39.02], zoom: 2.6 },
  { month: 3, date: "1592년 7월", title: "한산도 대첩", detail: "학익진으로 제해권을 잡다", win: true, sea: "한산도", impact: 1, focus: [128.48, 34.79], zoom: 3.2 },
  { month: 3.6, date: "1592년 7월", title: "이치 전투", detail: "전라도 방어선을 지켜내다", win: true, impact: 0.6, focus: [127.25, 35.95], zoom: 3.0 },
  { month: 6, date: "1592년 10월", title: "1차 진주성", detail: "김시민이 전라 진입을 막다", win: true, impact: 0.8, focus: [128.08, 35.19], zoom: 3.1 },
  { month: 4.5, date: "1592년 8월", title: "연안성 방어", detail: "이정암이 황해도 요충을 지키다", win: true, impact: 0.6, focus: [126.20, 37.90], zoom: 2.9 },
  { month: 8.5, date: "1592년 12월", title: "북관대첩", detail: "정문부가 함경도를 되찾다", win: true, impact: 0.9, focus: [129.35, 41.20], zoom: 2.3 },
  { month: 9, date: "1593년 1월", title: "평양성 탈환", detail: "조명연합군 반격 개시", win: true, impact: 0.9, focus: [125.75, 39.02], zoom: 2.7 },
  { month: 10.5, date: "1593년 2월", title: "행주대첩", detail: "권율, 한양 코앞에서 대승", win: true, impact: 1, focus: [126.82, 37.58], zoom: 3.1 },
  { month: 12, date: "1593년 4월", title: "한양 수복", detail: "일본군, 남해안 왜성으로 후퇴", win: true, impact: 0.7, focus: [126.98, 37.30], zoom: 2.2 },
  { month: 30, date: "1594~1596", title: "강화 협상", detail: "3년간의 교착", focus: [127.60, 35.30], zoom: 1.9 },
  { month: 63, date: "1597년 7월", title: "칠천량 패전", detail: "조선 수군이 궤멸하고 정유재란이 시작되다", impact: 0.9, focus: [128.70, 34.95], zoom: 3.0 },
  { month: 64, date: "1597년 8월", title: "남원 함락", detail: "지켜냈던 전라도가 뚫리다", impact: 1, focus: [127.39, 35.42], zoom: 3.0 },
  { month: 65, date: "1597년 9월", title: "명량 대첩", detail: "13척으로 133척을 막다", win: true, sea: "명량", impact: 1, focus: [126.30, 34.57], zoom: 3.2 },
  { month: 76, date: "1598년 8월", title: "도요토미 사망", detail: "일본군 철수 결정", focus: [127.40, 36.20], zoom: 1.7 },
