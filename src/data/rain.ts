 ...
 * 한 시간에 가장 많이 내린 비.
 *
 * 야마: 152.2mm. 그날 하루 내린 258.6mm의 59%가 그 한 시간에 왔다.
 * 2025년 9월 7일 군산. 한 시간이 나머지 스물세 시간보다 많다.
 *
 * 화면의 자는 바깥에서 빌려 온 것이 아니라 **그날 자기 하루**다.
 * 막대 하나가 그날 일강수량이고 아래쪽 색칠한 만큼이 그 한 시간이라
 * 단위가 사라진다 — 넷을 나란히 두면 색 비율이 뒤집히는 것이 보인다.
 *
...
export const LINES: string[] = [
  "종일 내린 비 · 그때까지 전국 1위였던 한 시간",
  "하루는 강화보다 173mm 더 · 한 시간은 1mm 차",
  "하루는 거제의 3분의 1 · 한 시간은 더 많다",
