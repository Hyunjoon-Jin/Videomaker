...
export interface Typhoon {
  ...
  /**
   * 사망·실종자 수.
   * 마무리에서 넷을 나란히 세울 때 쓴다. 문구에서 숫자를 뽑아 쓰는 대신
   * 따로 두는 이유는, 마무리 문장이 이 값들의 합에 기대고 있어서다.
   * 246 + 132 + 12 = 390. 사라 하나가 나머지 셋의 두 배가 넘는다.
   */
  dead: number;
  /**
   * 일 최대 강수량(mm)과 관측 지점.
...
export const TYPHOONS: Typhoon[] = [
  ...
  },
  {
    ...
    toll: "사망·실종 12명, 포항제철소 침수로 49년 만에 용광로가 멈췄다",
    dead: 12,
    color: "#8FA766",
