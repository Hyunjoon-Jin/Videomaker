...
export const Q_EVENTS: QEvent[] = [
  {
    year: 2017,
    kicker: "1900~2025 · 한반도",
    title: "지진 대부분 20km 안쪽",
    detail: "경주 2016 깊이 13km · 포항 2017 깊이 10km",
    cx: P(128.5, 37).x, cy: P(128.5, 37).y, z: 3.4, impact: 0.8,
  },
  {
    year: 2016,
    kicker: "2016년 9월 12일 · 경주",
    title: "M5.4 · 깊이 13km",
    detail: "계기관측 이래 남한 내륙 최대",
    cx: P(129.2, 36).x, cy: P(129.2, 36).y, z: 4.2, impact: 1, mark: "gyeongju",
  },
  {
    year: 2023,
    kicker: "2023년 9월 6일 · 함경북도 앞바다",
    title: "깊이 645km",
    detail: "M4.9 · 육지에서 34km 떨어진 바다 밑",
  ...
  },
  {
    ...
    detail: "한반도 상자 안에서 관측된 가장 큰 지진",
    cx: P(130.2, 42.2).x, cy: P(130.2, 42.2).y, z: 3.6, impact: 1, mark: "rajin",
  },
  {
    year: 2025,
    kicker: "북위 36~44도 단면",
    title: "동에서 서로 갈수록 깊어짐",
    detail: "143°E 깊이중앙 25km · 130°E 566km",
  ...
  },
  {
    ...
    detail: "지진이 나는 깊이는 여기서 끝 · 그 서쪽은 지진으로 알 수 없음",
