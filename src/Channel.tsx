      ...
      <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
        ...
        >
          ...
          {/*
            ...
            처음에는 '임진왜란 · 6·25 · 태풍 · 철도'였다. 지금 가진 목록이라
            다섯 번째를 올리면 낡는다.

            다음에는 '기록은 기록대로, 추정은 추정대로'였다. 이건 더 나쁘다.
            보간한 구간을 밝히는 건 영상 아래와 고정댓글에서 할 각주지
            채널의 정체가 아니다. 얼굴에 걸어두면 추정하는 채널이라고
            스스로 소개하는 셈이 된다.

            채널이 하는 일만 적는다. 소재도 각주도 아니고, 매번 같은 것.
          */}
          <div
            style={{
              color: "#BDB3A0",
